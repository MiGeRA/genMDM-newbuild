...
-	Чуток «магии» и размер бинарника стал ровно 1500 байт. Но красота-красотой (в классик-версии для второго порта оставил этот исходник: [genMDM-newbuild.asm](https://github.com/MiGeRA/genMDM-newbuild/blob/main/genMDM-newbuild.asm)), а бесполезного говно-кода осталось еще немало: решил вычистить и его (версия для третьего порта еще глубже оптимизирована и прокомментирована - её считаем основной: [genMDM-3-newbuild.asm](https://github.com/MiGeRA/genMDM-newbuild/blob/main/genMDM-3-newbuild.asm)), результат еще компактее и изящней.
